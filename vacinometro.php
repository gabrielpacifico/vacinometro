...
while ($array = mysqli_fetch_assoc($busca)){
      ...
      $porcent = ($doses_aplicadas * 100 / $vacinas_recebidas); /** % de vacinas aplicadas */
?>

<section>
  <div id="welcome" class="container">
     <center> <h1 style="margin-top:20px" id="bemv">Bem vindos ao vacinômetro da prefeitura de Independência</h1> </center>
  <div style="margin-top: 30px" class="row">
    <div class="col-sm">
      ...
      <div id="vac"><h1 id="vac"><?php echo $vacinas_recebidas ?></h1></div> 
    </div>
    <div class="col-sm">
        <?php
        ...
        $sum = ($primeira + $segunda + $terceira + $quarta);
      ...
      <div id="vac1"><h1 id="vac1"><?php echo $doses_aplicadas ?></h1></div>
    </div>
    <div class="col-sm">
      <h2 id="card">Das doses foram aplicadas:</h2>
      <div id="vac2"><h1 id="vac2">&nbsp;&nbsp;<?php echo mb_strimwidth($porcent,0,5)?>%</h1></div>
    </div>
  </div>
  <div class="container">
  <div class="row">
  ...
  <!-- Ultimas vacinas aplicadas -->
    ...
    <div id="lastvac">
      ...
      <?php 
        ...
        $res_ult_vacina = date('d/m/Y', strtotime($ult_vacina)); /** Data da última vacina aplicada convertida pra BR */
    ...
    <div id="lastvac2">
      ...
      <?php
          ...
          $res_ult_entrada = date('d/m/Y', strtotime($ult_entrada)); /** Data da última entrada de vacina convertida pra BR */
      ?>
    ...
    <div class="col">
      <a href="unidadesdeatendimento.php" style="text-decoration: none;">
        <div id="uniatend">
          ...
          <h2 id="quadrados">atendimento</h2></a>
        </div>  
    </div>
    ...
    <div class="col">
      <a href="perguntaserespostas.php" style="text-decoration: none;">
        <div id="perguntas">
          ...
          <h2 id="quadrados">respostas</h2></a>
        </div>
    </div>
    ...
    <div class="col">
      <a href="listavacinados.php" style="text-decoration: none;">
        <div id="vacinados">
          ...
          <h2 id="quadrados">vacinados</h2></a>
        </div>
    </div>
...
<!-- Categorias -->
            ...
            $quant_categoria = "SELECT count(categoria) as categoria from beneficiarios where categoria = 'Idosos com 70 anos ou mais'";
            ...
            <div class="row justify-content-center">
                ...
                <h2 id="cattext">Idosos com 70 anos ou mais: <?php echo $resultado_idosos70 ?> </h2>
                </div>
            ...
            include 'conexao.php';
              ...
              $quant_categoria = "SELECT count(categoria) as categoria from beneficiarios where categoria = 'Profissionais da segurança pública'";
              $categoria_result = mysqli_query($conexao, $quant_categoria);
            
              while($array = mysqli_fetch_array($categoria_result)){
                    $resultado_segpu = $array['categoria']; 
            
              ?>
                  <div class="col-md-5" id="cardcat12">
                  <h2 id="cattext">Profissionais da segurança pública: <?php echo $resultado_segpu ?> </h2>
                  </div> 
  ...
  <section id="tabela7dias">
    ...
    <table id="ultim7" class="table table-hover table-bordered table-responsive">
      ...
      while($array = mysqli_fetch_array($busca)){
        ...
        $data_nasc_convert = date('d/m/Y', strtotime($data_nasc)); /** Data de nascimento convertida pra BR */
        ...
        $data_de_vac_2_convert = date('d/m/Y', strtotime($data_de_vacinacao_2)); /** Data de vacinação convertida pra BR */
        $data_de_vacinacao_3 = $array['data_de_vacinacao_3'];
        $data_de_vac_3_convert = date('d/m/Y', strtotime($data_de_vacinacao_3)); /** Data de vacinação convertida pra BR */
        $data_de_vacinacao_4 = $array['data_de_vacinacao_3'];
        $data_de_vac_4_convert = date('d/m/Y', strtotime($data_de_vacinacao_4)); /** Data de vacinação convertida pra BR */
