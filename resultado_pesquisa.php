...
use Sabberworm\CSS\Value\Value;
      ...
      if(empty($_GET['buscanome']) AND empty($_GET['buscacpf']) AND empty($_GET['buscasus']) AND empty($_GET['datavac'])){
        ...
        Campos de pesquisa vazios, tente novamente.
              ...
              //   OR local_vacinacao_3 = '$ubs_beneficiario' OR local_vacinacao_4 = '$ubs_beneficiario'";
              // }
              // PESQUISA COM DATA DE VACINAÇÃO E BENFICIARIO JUNTOS.
  ...
  <a href="listavacinados.php" class="btn btn-primary" role="button" id="voltar"><i class="fas fa-arrow-left"></i></a>
    </div>
  </div>
