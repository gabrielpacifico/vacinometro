                    ...
                    <div class="col-md-5  m-3" style="text-align: left;">
                      ...
                      <div class="col-md-5 m-3" style="text-align: left;">
                        ...
                        <select name="categoriavac" class="form-select">
                          <option <?=($categoria == 'Idosos com 70 anos ou mais')?'selected':''?> > Idosos com 70 anos ou mais </option>
                          ...
                          <option <?=($categoria == 'Profissionais da segurança pública')?'selected':''?> > Profissionais da segurança pública </option>
