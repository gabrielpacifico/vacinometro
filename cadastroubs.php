...
<head>
    ...
    <title> Vacinômetro - Cadastro de UBS</title>
...
<body>
    ...
    <section id="navtop">
      ...
      <a href="logout.php" class="btn btn-sm btn-warning" style="margin-top: 15px; float: right;">Fazer logout</a>
        <center>
            <h1 id="titlevacinados">Cadastro de UBS</h1>
        </center>
        <a href="cadastro_geral.php" class="btn btn-primary" role="button"><i class="fas fa-arrow-left"></i></a>
        <div id="subvac">
            <h2 id="subtitlecadastro"><i class="fas fa-question-circle"></i>&nbsp; Cadastro das UBS de Indepêndencia/CE.</h2>
        </div>

        <center>
            
        <form action="cadastroubs_concluido.php" method="POST">
          <div class="form-control">
            <div class="col-md-5  m-3" style="text-align: left;">
              <label>UBS: </label>
                  <input type="name" name="ubs" class="form-control" placeholder="Unidade de saúde" autocomplete="off" required>
              </div>
              
              <div class="col-md-5  m-3" style="text-align: left;">
              <label>Endereço: </label>
                  <input type="name" name="endereco" class="form-control" placeholder="Endereço" autocomplete="off" required>
              </div>

              <div class="col-md-5  m-3" style="text-align: left;">
              <label>Horários de funcionamento: </label>
                  <input type="name" name="horario" class="form-control" placeholder="Horário de funcionamento" autocomplete="off" required>
              </div>

              <div class="col-md-5  m-3" style="text-align: left;">
              <label>Telefone: </label>
                  <input type="tel" name="telefone" class="form-control" placeholder="Telefone" autocomplete="off">
              </div>
              <div class="col-md-5 m-3">
                <a href="cadastro_geral.php"  style="margin-bottom: 30px;"  class="btn btn-primary" role="button">Menu cadastro</a>
          
                <button type="submit" class="btn btn-success"  style="margin-bottom: 30px;"  onclick="return confirm('Você tem certeza que deseja cadastrar essa UBS?')">Cadastrar</button>
            </div>
          </div>
        </form>
      </section>
