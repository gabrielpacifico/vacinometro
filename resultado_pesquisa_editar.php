...
<section class="container" id="resultpesquisa">
    ...
    <div class="container">
      ...
      if(empty($_GET['buscanome']) AND empty($_GET['buscacpf']) AND empty($_GET['buscasus']) AND empty($_GET['datavac'])){
        echo "<style> 
              footer#footer{
              display: block;
              position: absolute;
          ...
          Campos de pesquisa vazios, tente novamente.
              ...
              if($beneficiario != "" || $beneficiario != NULL AND $datavac_beneficiario != "" || $datavac_beneficiario != NULL){ 
              ...
              }elseif($beneficiario != "" || $beneficiario != NULL){
                $result_geral = $query . "beneficiario LIKE '%$beneficiario%' ";
              }elseif($datavac_beneficiario != "" || $datavac_beneficiario != NULL){
              ...
              if($cpf_beneficiario != "" || $cpf_beneficiario != NULL){
                $result_geral = $query . "cpfbeneficiario LIKE '$cpf_beneficiario' ";
              }
              if($sus_beneficiario != "" || $sus_beneficiario != NULL){
        ...
        <tbody>
          <tr>
            ...
            <td> <?php echo $buscar_unidade ?></td>
            

            <td> <a href="editar_beneficiario.php?id=<?php echo $id_beneficiarios ?>" class="btn btn-info" role="button"><i class="fas fa-edit"></i></a>
                <a href="excluir_beneficiario.php?id=<?php echo $id_beneficiarios ?>" class="btn btn-danger" style="margin-left: 5px;" role="button" onclick="return confirm('Tem certeza que deseja excluir?')"><i class="fas fa-trash"></i></a> </td>
           </td>
            <?php
            }
            } 
