...
?>
    ...
    <p><strong>Data de vacinação: </strong> 
    <?php if($data_de_vacinacao == "0000-00-00"){
            echo "";
          }else{
            echo $data_de_vacinacao_convert;
          }
    ?>
    </p>
    <p><strong>Lote: </strong> <?php echo $lote_1_dose?></p>
    
    <?php if($vacina == "Vacina"){
            echo "<p><strong>Vacina: </strong> </p>";
          }else{
    ...
    <?php if($vacinador == "Vacinador"){
            echo "<p><strong>Vacinador: </strong> </p>";
          }else{
            echo "<p><strong>Vacinador: </strong> $vacinador </p>";
          }
    ?>

    <?php if($local_vacinacao == "Local de vacinação"){
            echo "<p><strong> Local de vacinação: </strong> </p>";
          }else{
    ...
    <?php
      ...
      if($dose == "Dose única + reforço"){
        ...
        echo "<p><strong>Lote: </strong> $lote_2_dose </p>";
                ...
                if($local_vacinacao_2 == "Local de vacinação"){
                  echo "<p><strong> Local de vacinação: </strong> </p>";
                }else{
    ...
    if($dose == 2){
      ...
      echo "<p><strong>Lote: </strong> $lote_3_dose </p>";
                ...
                if($local_vacinacao_3 == "Local de vacinação"){
                  echo "<p><strong> Local de vacinação: </strong> </p>";
                }else{
      ...
      if($dose == 4){
        ...
        echo "<p><strong>Lote: </strong> $lote_4_dose </p>";
                ...
                if($local_vacinacao_4 == "Local de vacinação"){
                  echo "<p><strong> Local de vacinação: </strong> </p>";
                }else{
