...
if($id >= 0){
	...
	$update = "UPDATE usuarios SET stats = 'Ativo' WHERE id_usuario = $id";
...
<head>
    ...
    <title> Vacinômetro - Usuário aprovado! </title>
...
<body>
    ...
    <section id="navtop">
      ...
      <center><br><br><h2 id="cadastroconcluido"> Usuário aprovado com sucesso! </h2>
