...
<head>
    ...
    <title> Vacinômetro - Cadastro de UBS concluído</title>
...
<body>
    ...
    <section id="navtop">
      ...
      <?php 
        ...
        $sqlcode = "INSERT INTO `unidades`(`unidade`,`endereco`,`horario`,`telefone`) VALUES ('$ubs', '$endereco', '$horario', '$tel')";

        if (mysqli_query($conexao, $sqlcode)) {
        
            ?> <center><br><br><h2 id="cadastroconcluido"> Cadastro feito com sucesso! </h2>
             <a href="cadastroubs.php" class="btn btn-primary" style="margin-top: 30px;">Voltar</a></center> <?php
                                                }
