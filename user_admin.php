...
if($id >= 0){
	...
	$update = "UPDATE usuarios SET cargo = 'Administrador' WHERE id_usuario = $id";
...
<body>
    ...
    <section id="navtop">
      ...
      <center><br><br><h2 id="cadastroconcluido"> Usuário atualizado para administrador com sucesso! </h2>
