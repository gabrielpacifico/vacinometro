    ...
    <section id="navtop">
      ...
      <section class="container" id="cadastro">
        ...
        <div class="row" id="cadastro_geral">
          <div class="col">
            <a href="cadastro_vacinas.php"><div id="cardcadastro1">
                <h2 id="iconscadastro"><i class="fas fa-syringe"></i></h2>
                <h1 id="cadastro">Cadastrar a quantidade de vacinas recebidas e doses aplicadas</h1></a>
            </div>
          </div>

          <div class="col">
            <a href="cadastro_entradas.php"><div id="cardcadastro2">
              <center>
                <h2 id="iconscadastro"><i class="fas fa-box"></i></h2>
                <h1 id="cadastro">Cadastrar a entrada de vacinas</h1></a>
              </center>
            </div>
          </div>

          <div class="col">
            <a href="cadastro_vacinados.php"><div id="cardcadastro3">
                <h2 id="iconscadastro"><i class="fas fa-user-plus"></i></h2>
                <h1 id="cadastro">Cadastrar os vacinados contra a Covid-19</h1></a>
            </div>
          </div>

          <div class="col">
            <a href="listavacinados_editar.php"><div id="cardcadastro4">
              <center>
                <h2 id="iconscadastro"><i class="fas fa-user-edit"></i></h2>
                <h1 id="cadastro">Editar beneficiários já cadastrados</h1></a>
              </center>
            </div>
          </div>
