...
<head>
  ...
  <title>Lista de vacinados</title>
...
<section class="container" id="listadevacinados">
    ...
    <div class="container"> 
      <a style="margin-bottom: 20px;" href="vacinometro.php" class="btn btn-primary" role="button"><i class="fas fa-arrow-left"></i></a>
    ...
    <section id="secbuscar" class="container">
      <form method="GET" action="resultado_pesquisa.php">
      <div class="row" id="listavacinados">
        ...
        <?php 
          ...
          /** EXIBINDO A QUANTIDADE DE REGISTROS ENCONTRADOS */
              ...
              $quant_registros = "SELECT count(beneficiario) as beneficiario from beneficiarios";
        ...
        <tbody>
          <tr>
            ...
            <td> 
              ...
              <?php if($vacina_4 == NULL || $vacina_4 == "Vacina"){
              echo "";
